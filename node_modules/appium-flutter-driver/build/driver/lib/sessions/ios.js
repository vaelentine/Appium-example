...
exports.getObservatoryWsUri = exports.startIOSSession = exports.DRIVER_NAME = void 0;
// @ts-ignore
...
const startIOSSession = async (caps, ...args) => {
    ...
    try {
        observatoryWsUri = await (0, exports.getObservatoryWsUri)(iosdriver);
    }
    catch (e) {
    ...
    return Promise.all([
        iosdriver,
        (0, observatory_1.connectSocket)(observatoryWsUri, caps.retryBackoffTime, caps.maxRetryCount),
    ]);
};
...
const getObservatoryWsUri = async (proxydriver) => {
    const urlObject = (0, observatory_1.processLogToGetobservatory)(proxydriver.logs.syslog.logs);
