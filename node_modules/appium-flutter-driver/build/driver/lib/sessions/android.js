...
exports.getObservatoryWsUri = exports.startAndroidSession = exports.DRIVER_NAME = void 0;
...
const startAndroidSession = async (caps, ...args) => {
    ...
    try {
        observatoryWsUri = await (0, exports.getObservatoryWsUri)(androiddriver, caps);
    }
    catch (e) {
    ...
    return Promise.all([
        androiddriver,
        (0, observatory_1.connectSocket)(await observatoryWsUri, caps.retryBackoffTime, caps.maxRetryCount),
    ]);
};
exports.startAndroidSession = startAndroidSession;
const getObservatoryWsUri = async (proxydriver, caps) => {
    const urlObject = (0, observatory_1.processLogToGetobservatory)(proxydriver.adb.logcat.logs);
